export const RoseControl = (props) => {
  ...
  return (
    <svg viewBox="25 15 250 165" onClick={handleClick}>
      ...
      <g style={{ fill: "rgb(255, 255, 255)", pointerEvents: "fill" }}>
        <polygon
          stroke="#3a3a3a"
          data-id="b1"
      ...
      <g>
        ...
        <text transform="matrix(1 0 0 1 99.5801 174.9004)" font-size="10">
          S
        </text>
        <text transform="matrix(1 0 0 1 170.5957 104.582)" font-size="10">
          E
        </text>
        <text transform="matrix(1 0 0 1 150.4736 51.3208)" font-size="7">
          NE
        </text>
        <text transform="matrix(1 0 0 1 151.1943 152.7061)" font-size="7">
          SE
        </text>
        <text transform="matrix(1 0 0 1 44.459 51.3208)" font-size="7">
          NW
        </text>
        <text transform="matrix(1 0 0 1 45.1797 152.7061)" font-size="7">
          SW
        </text>
        <text transform="matrix(1 0 0 1 25.6279 104.582)" font-size="10">
          W
        </text>
        <text
